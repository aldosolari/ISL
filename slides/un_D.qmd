...
amounts to [fitting the data hard]{.blue} and potentially overfitting,
...
**Figure 17.8.** ALS test error for boosted models with different tree depths $d$, all using the same shrinkage parameter $\lambda 00.02$.
